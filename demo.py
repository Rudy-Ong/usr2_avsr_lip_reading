...
def transcribe(video_path: str, cfg: DictConfig, modality: str = "av",
               ...
               detector: str = "retinaface"): # "mediapipe" or "retinaface"
...
def main(cfg: DictConfig):
    ...
    detector = cfg.get("detector", "retinaface") # Default to "mediapipe" for backward compatibility, but can be overridden by config
